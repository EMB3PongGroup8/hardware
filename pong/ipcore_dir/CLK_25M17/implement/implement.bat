...
xst -ifn xst.scr
move CLK_25M17_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK_25M17_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK_25M17_exdes.ucf CLK_25M17_exdes

echo 'Running map'
map -timing -pr b CLK_25M17_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm CLK_25M17_exdes -w routed.ncd routed.vhd
cd ..
